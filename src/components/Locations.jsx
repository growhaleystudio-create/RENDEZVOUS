...
export default function Locations({ onOpenBooking }) {
  ...
  const locationsData = [
    ...
    },
    {
      ...
      mapsUrl: 'https://maps.google.com',
      isFlagship: false,
      pinPos: { top: '65%', left: '68%' },
    },
    {
      id: 'graha',
      district: 'surabaya',
      name: 'Graha Famili',
      badge: 'SURABAYA BARAT',
      image: '/images/loc_mutual.jpg',
      address: 'Jl. Mayjen Yono Suwoyo No. 12, Graha Famili, Surabaya Barat',
      phone: '+62 31-738-4321',
      hours: 'Sen - Sab: 09:00 – 20:30 | Min: 10:00 – 19:00',
      note: 'Akses Eksklusif & Private Grooming Suite',
      mapsUrl: 'https://maps.google.com',
      isFlagship: false,
      pinPos: { top: '58%', left: '76%' },
    },
  ];
